 ...
 */
class AdvancedBloomFilter extends vf.gui.Filter {
    bloomScale:number;
    brightness:number;
    _extractFilter:any;
    _blurFilter:any;
    ...
    constructor() {
        ...
        this._extractFilter = new ExtractBrightnessFilter(o.threshold);
     ...
     * @private
     */
    apply(filterManager:any, input:any, output:any, clear:any, currentState:any) {
