 ...
 * @memberof vf.filters
 */
export class BlurFilterPass extends vf.gui.Filter
{
     ...
     */
    constructor(horizontal: boolean, strength = 8, quality = 4, resolution = vf.settings.RESOLUTION, kernelSize = 5)
    {
    ...
    ): void
    {
        ...
        else
        {
            ...
            filterManager.applyFilter(this, flip, flop, vf.CLEAR_MODES.CLEAR);

            for (let i = 1; i < this.passes - 1; i++)
            {
                filterManager.bindAndClear(flip, vf.CLEAR_MODES.BLIT);
