 ...
 *
 * @class
 * @extends vf.gui.Filter
 * @memberof vf.gui.filters
 */
export class BlurFilter extends vf.gui.Filter
{
    ...
    public resolution:any = vf.settings.RESOLUTION;
    public kernelSize:number = 5;
    constructor()
    {
        super();

        this.blurXFilter = new BlurFilterPass(true, this.strength, this.quality, this.resolution, this.kernelSize);
        this.blurYFilter = new BlurFilterPass(false, this.strength, this.quality, this.resolution, this.kernelSize);
 
        this.blur = this.strength;
    ...
    apply(filterManager: vf.systems.FilterSystem, input: vf.RenderTexture, output: vf.RenderTexture, clearMode: vf.CLEAR_MODES): void
    {
        ...
        if (xStrength && yStrength)
        {
            ...
            this.blurXFilter.apply(filterManager, input, renderTarget, vf.CLEAR_MODES.CLEAR);
