...
export interface IFilterTarget
{
    ...
    getBounds(skipUpdate?: boolean): vf.Rectangle;
}
 ...
 */
export class DisplacementFilter extends vf.gui.Filter
{
    public maskSprite: ISpriteMaskTarget;
    public maskMatrix: vf.Matrix;
    public scale: vf.Point;
    ...
    constructor(sprite: ISpriteMaskTarget, scale: number)
    {
         ...
         * @member {PIXI.Point}
         */
        this.scale = new vf.Point(scale, scale);
    }
     ...
     */
    public apply(
        filterManager: vf.systems.FilterSystem, input: vf.RenderTexture, output: vf.RenderTexture, clearMode: vf.CLEAR_MODES
    ): void
    {
        // fill maskMatrix with _normalized sprite texture coords_
        this.uniforms.filterMatrix = filterManager.calculateSpriteMatrix(this.maskMatrix, this.maskSprite as any);
